...
RSpec.configure do |config|
  ...
  config.after(:all, :elasticsearch) do
    Elasticsearch::Extensions::Test::Cluster.stop port: 9250, network_host: 'localhost', number_of_nodes: 1 if Elasticsearch::Extensions::Test::Cluster.running?(on: 9250)
  end
end
